...
#ifdef __WIFIMAIN__
= {
    { "D-link", "83879398BB", TZ_EST },	// 274 Jackson Pines Rd, Jackson
    { "NoSuchAgency", "83879398bb", TZ_EST },	// Dud's phone hotspot
    { "Yeldud's Bar", "3109717683", TZ_PST },	// 1848 El Rey Rd, San Pedro
    { "Yeldud UP", "3109717683", TZ_PST },	// 1848 El Rey Rd, San Pedro
    { "1313", "67032106", TZ_CHINA },		// Zhao & Wang's apartment
    { "WJ", "wangjun19790611", TZ_CHINA },	// Wang Jun's portable hotspot
    ...
    { "TG1672GE2", "TG1672GE43AE2", TZ_EST },	// Geo & Eileen's house in NC
    { "NETGEAR Qin32", "Gutsmodernraven47", TZ_EST }	// Marvin & Cindy NYC
}
#endif
;
